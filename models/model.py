...
class Candidate(Base):
    ...
    jd_assessments = relationship("JDAssessment",back_populates="candidate",cascade="all, delete-orphan")
...
class JDAssessment(Base):
    __tablename__ = "jd_assessment"
    __table_args__ = {'extend_existing': True}
    ...
    candidate = relationship(
        "Candidate",
        back_populates="jd_assessments"
    )

    # Relationship with generated questions
...
class JDQuestion(Base):
    __tablename__ = "jd_questions"
    __table_args__ = {'extend_existing': True}
    ...
    # Candidate's answer - will be used later
    candidate_answer = Column(
        Text,
        nullable=True
    )

    # AI evaluation - will be used later
    ai_score = Column(
        Integer,
        nullable=True
    )
